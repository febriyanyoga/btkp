...
class WorkshopM extends CI_Model{
	...
	public function get_berkas_by_id_perizinan($id_perizinan){
	...
	public function hapus_berkas_perizinan($id_detail_berkas_perizinan){
		$this->db->where('id_detail_berkas_perizinan', $id_detail_berkas_perizinan);
		$this->db->delete('detail_berkas_perizinan');
		return TRUE;
	}
