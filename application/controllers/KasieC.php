    		...
    		if ($this->GeneralM->insert_persetujuan_pengujian($data)) {
    			if($this->input->post('status') == 'diterima'){
    				$data_email = array(
    					...
    					'nomor'                 => $this->input->post('nomor'),
    					'salam'                 => 'Selamat . . .',
    					'isi'                   => '<b>Telah berhasil</b> di verifikasi oleh Kasie Balai Teknologi Keselamatan Pelayaran (BTKP). Silahkan masuk ke aplikasi untuk melakukan tahapan selanjutnya yaitu pembayaran dan konfirmasi pembayaran.<br> Terimakasih.',
    				);
    				$subject    = 'Pemberitahuan';
    				$to         = $this->input->post('email_pengguna');
    				...
    				$data_email = array(
    					...
    					'nomor'                 => $this->input->post('nomor'),
    					'salam'                 => 'Mohon maaf. . .',
    					'isi'                   => '<b>Belum berhasil</b> di verifikasi oleh Kasie Balai Teknologi Keselamatan Pelayaran (BTKP) Silahkan masuk ke aplikasi untuk melihat detail permohonan.<br> Terimakasih.',
    				);
    				$subject    = 'Pemberitahuan';
    				$to         = $this->input->post('email_pengguna');
    				$isi        = $this->load->view('email/Notifikasi_verifikasi', $data_email, TRUE);
