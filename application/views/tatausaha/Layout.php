...
<body>
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li>
							...
							<div class="user-profile dropdown m-t-20">
								...
								<div class="user-content hide-menu m-t-10">
									<h5 class="m-b-10 user-name font-medium">Admin TU</h5>
									<a href="javascript:void(0)" class="btn btn-circle btn-sm m-r-5" id="Userdd" role="button" data-toggle="dropdown"
									 aria-haspopup="true" aria-expanded="false">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?php echo site_url('tatausaha/dashboard'); ?>" aria-expanded="false">
						...
						<li class="sidebar-item">
							<a class="sidebar-link" href="<?php echo site_url('tatausaha/perizinan_baru'); ?>" aria-expanded="false">
								<i class="icon-Car-Wheel"></i>
    ...
    <script src="<?php echo base_url(); ?>assets/app/dist/js/app.init.js"></script>
