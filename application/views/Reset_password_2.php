            ...
            <div class="row flex-row h-100">
                <div class="col-12 my-auto">
                    <div class="password-form mx-auto">
                        ...
                        <form action="<?php echo site_url('post_atur_ulang')?>" method="post">
                            <div class="group material-input">
                                <input type="password" name="password_baru" id="password_baru" required>
							    <input type="hidden" name="id_pengguna" id="id_pengguna" value="<?= $id_pengguna;?>" required>
                            ...
                            <div class="group material-input">
                                <input type="password" name="ulangi_password_baru" id="ulangi_password_baru" required>
                                <span class="highlight"></span>
                                <span class="bar"></span>
