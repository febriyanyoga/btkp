                        ...
                        <div class="card">
                            <div class="card-body wizard-content">
                                ...
                                <form action="#" class="validation-wizard wizard-circle m-t-40">
                                    <!-- Step 1 -->
                                    <h6>Langkah 1 - Identitas Workshop</h6>
                                    <section>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wfirstName2"> Nama Workshop : <span class="danger">*</span> </label>
                                                    <input type="text" class="form-control required" id="wfirstName2" name="firstName"> </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="wlastName2"> Alamat : <span class="danger">*</span> </label>
