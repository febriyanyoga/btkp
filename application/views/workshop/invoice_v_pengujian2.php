  ...
  <section id="memo">
    <div class="company-info">
      ...
      <div style="font-size: 20px; font-weight: bold;">
        <span>Balai Teknologi Keselamatan Perlayaran<hr>
          <span style="text-align: right; right: 30px; position: absolute; font-size: 12pt;">#TG<?php echo $pengujian->kode_billing_2;?>/INV</span>
        </div>
        <div>
    ...
    <section id="items" style="margin-top: 20px;">
      ...
      <table >
        <tr> <th style="background-color: #e6e7e7; border-bottom: 0px solid; text-align: center; font-size:16px; font-weight: bold; color:#555;">
          <?php 
          $tgl_berlaku   = date('Y-m-d', strtotime($pengujian->masa_berlaku_billing_2));
          echo longdate_indo($tgl_berlaku).' Pukul '.date('H:i', strtotime($pengujian->masa_berlaku_billing_2));
          ?>
        </th></tr>
      </table>
    </section>
    ...
    <section id="items">
      <table style="margin-top: -45px;" >
        ...
        <tr> <th style="background-color: #fff; border-bottom: 0px solid; text-align: center; font-size:18px; font-weight: bold; color:#555;"><?php echo "Rp".number_format($pengujian->jumlah_tagihan_2, 0,',','.').",-";?></th></tr>
      </table>
    </section>
   ...
   <!--  <section id="items">
      <table style="margin-top: -45px;">
        <?php
        $bank = $this->WorkshopM->cek_bank_btkp($pengujian->id_bank_btkp_2)->row();
        ?>
    ...
    <section id="items">
      <table style="margin-top: -45px;" >
        ...
        <tr> <th style="background-color: #fff; border-bottom: 0px solid; text-align: center; font-size:18px; font-weight: bold; color:#555;"><?php echo $pengujian->kode_billing_2?></th></tr>
      </table>
    </section>

    <section id="invoice-title-number">
      <span id="number">Berikut adalah rincian tagihan pembayaran <b>Jasa Pecetakan Label</b> : </span>
    </section>
    ...
    <?php
    if($pengujian->status_pembayaran_2 == 'paid'){
      ?>
