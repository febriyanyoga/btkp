												...
												foreach ($berkas as $ber) {
													...
													<div class="col-xl-6 mb-3">
														...
														<div class="custom-file">
															...
															<input type="text" name="nama_file<?php echo $i;?>" id="nama_file<?php echo $i;?>" value="<?php echo $ber->nama_file;?>">
															<input type="text" name="ukuran_berkas<?php echo $i;?>" id="ukuran_berkas<?php echo $i;?>" value="<?php echo $ber->ukuran_berkas;?>">
														</div>
													</div>
													<?php
												}
