    			...
    			<nav class="navbar fixed-top">
    				...
    				<div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
    					...
    					<ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
    						<!-- Search -->
    						<li class="nav-item d-flex align-items-center"><a href="<?php echo site_url('kasie'); ?>"><i class="la la-home"></i></a></li>
    						...
    						<li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown"
    							...
    							<ul aria-labelledby="user" class="user-size dropdown-menu">
    								<li class="welcome">
    									<a href="<?php echo site_url('profil_k'); ?>" class="edit-profil"><i class="la la-gear"></i></a>
