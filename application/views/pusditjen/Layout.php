			...
			<div class="compact-sidebar light-sidebar has-shadow">
				...
				<nav class="side-navbar box-scroll sidebar-scroll">
					...
					<ul class="list-unstyled">
						<li>
							<a href="<?php echo site_url('pusditjen'); ?>">
								<i class="ion-home"></i><span> Dashboard</span>
							</a>
						</li>
						<li>
							<a href="<?php echo site_url('laporan_perusahaan'); ?>">
								<i class="ti ti-notepad"></i><span> Workshop</span>
							</a>
						</li>
						<li>
						...
						<li>
							<a href="<?php echo site_url('laporan_inspeksi'); ?>">
