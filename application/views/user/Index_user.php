                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable" style="height:560px;">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2">
                                        <img src="<?php echo base_url()?>assets/app/images/users/1.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="<?php echo base_url()?>assets/app/images/users/2.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="<?php echo base_url()?>assets/app/images/users/5.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="<?php echo base_url()?>assets/app/images/users/6.jpg" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
                                        <h6 class="font-medium">James Anderson</h6>
                                        <span class="m-b-15 d-block">Lorem Ipsum is simply dummy text of the printing and type setting industry. </span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable position-relative" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        <li class="chat-item">
                                            <div class="chat-img">
                                                <img src="<?php echo base_url()?>assets/app/images/users/1.jpg" alt="user">
                                            </div>
                                        ...
                                        <li class="chat-item">
                                            <div class="chat-img">
                                                <img src="<?php echo base_url()?>assets/app/images/users/2.jpg" alt="user">
                                            </div>
                                            <div class="chat-content">
                                        ...
                                        <li class="chat-item">
                                            <div class="chat-img">
                                                <img src="<?php echo base_url()?>assets/app/images/users/3.jpg" alt="user">
                                            </div>
                                            <div class="chat-content">
