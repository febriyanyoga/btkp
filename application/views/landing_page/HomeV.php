	...
	<body class="layout-wide slideshow-background">
		...
		<div class="site-container">
			...
			<div class="ln-fullpage" data-navigation="true">
				...
				<section class="ln-section d-xl-flex" data-anchor="about" data-tooltip="About" data-overlay-color="#00050e" data-overlay-opacity="90">
					<div class="overlay has-mobile-overlay">
						<div class="overlay-inner"></div>
					</div>
				...
				<section class="ln-section d-xl-flex" data-anchor="perijinan" data-tooltip="Perijinan" data-overlay-color="#00050e" data-overlay-opacity="90">
					<div class="overlay has-mobile-overlay">
						<div class="overlay-inner"></div>
					</div>
					<div class="container align-self-xl-center">
