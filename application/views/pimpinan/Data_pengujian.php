									...
									<table id="myTable" class="table mb-0">
										...
										<tbody>
											...
											foreach ($pengujian as $ujian) {
												...
												if($ujian->status_pengajuan == 'selesai' && $ujian->foto_bukti_trf_1 == ''){
													$i++;
													$verifikasi_ujian+=1;
													...
													<tr>
														...
														<td class="text-center">
															<?php
															if ($ujian->foto_bukti_trf_1 == '' && $ujian->kode_billing_1 != '') {
																?>
																<span style="width:100px; " title="Menunggu pembayaran"><span class="badge-text badge-text-small info">Menunggu pembayaran</span></span>
																<?php
															}else{
																?>
																<span style="width:100px; " title="Menunggu file survey diUnggah"><span class="badge-text badge-text-small info">Menunggu verifikasi dan kode billing</span></span>
																<?php
															}
															?>
														</td>
										...
										<tbody>
											...
											foreach ($pengujian as $ujian) {
												...
												if($ada_status > 0){
													...
													if($ujian->foto_bukti_trf_1 != "" && $ujian->kode_billing_2 == '' && $progress_kasie == 0){
														// $status = $this->WorkshopM->cek_status($ujian->id_pengujian)->row();
														$i++;
														$pengujian_ujian+=1;
														$tgl_pengajuan = date('Y-m-d', strtotime($ujian->created_at_ujian));
														...
														<tr>
															...
															<td class="text-center">
																...
																if($ujian->file_hasil_pengujian != ''){
																	?>
																	<span style="width:100px; " title="pembayaran terverifikasi"><span class="badge-text badge-text-small info">Menunggu verifikasi akhir</span></span>
																	<?php
																}else{
																	?>
																	<span style="width:100px; " title="pembayaran terverifikasi"><span class="badge-text badge-text-small success">Pembayaran terverifikasi</span></span>
																	<?php
																}
																?>
															</td>
									...
									<table id="myTable4" class="table mb-0">
										<thead>
											<tr>
												...
												<th class="text-center">Instansi</th>
												<th class="text-center">Status</th>
												<!-- <th class="text-center">get_array_progress_ujian_kasie</th> -->
											</tr>
										</thead>
										<tbody>
											<?php
                                                        			...
                                                        			<td class="text-center">
                                                        				...
                                                        				if($ujian->foto_bukti_trf_2 == ''){
                                                        					if($ujian->kode_billing_2 == ''){
                                                        						?>
                                                        						<span style="width:100px;"><span class="badge-text badge-text-small info">Menunggu Kode Billing</span></span>
                                                        						<?php
                                                        					}else{
                                                        						?>
