			...
			<nav class="navbar fixed-top">
				...
				<div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
					...
					<div class="navbar-header">
						<a href="<?php echo site_url('pimpinan'); ?>" class="navbar-brand">
					...
					<ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
						<li class="nav-item d-flex align-items-center"><a href="<?php echo site_url('pimpinan'); ?>"><i class="la la-home"></i></a></li>
						<!-- Search -->
						...
						<li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown"
							...
							<ul aria-labelledby="user" class="user-size dropdown-menu">
								<li class="welcome">
									<a href="<?php echo site_url('profile_pimpinan'); ?>" class="edit-profil"><i class="la la-gear"></i></a>
								...
								<li>
									<a href="<?php echo site_url('profile_pimpinan'); ?>" class="dropdown-item">
										Profile
									</a>
								</li>
								<!-- <li>
			...
			<div class="compact-sidebar light-sidebar has-shadow">
				...
				<nav class="side-navbar box-scroll sidebar-scroll">
					...
					<ul class="list-unstyled">
						...
						<li>
							<a href="<?php echo site_url('pengujian_pimpinan'); ?>">
								<i class="ti ti-write"></i><span> Data Pengujian </span>
							</a>
						</li>
						<li>
							<a href="<?php echo site_url('reinspeksi_pimpinan'); ?>">
