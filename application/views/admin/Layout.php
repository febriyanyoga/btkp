	...
	<div class="page db-social">
					...
					<div class="navbar-header">
						<a href="<?php echo site_url('admin'); ?>" class="navbar-brand">
							<div class="brand-image brand-big">
								<img src="<?php echo site_url();?>assets/logo.png" alt="logo" style="width: 70px;"
									class="logo-big">
							</div>
		...
		<div class="page-content d-flex align-items-stretch">
			...
			<div class="content-inner compact"
				style="background:url(<?php echo base_url(); ?>assets/bg5.jpg); background-size: cover;">
				...
				<footer class="main-footer">
					<div class="row">
						<div
							...
							<p class="text-gradient-02">Develop By Soepomo 84</p>
						</div>
						<div
...
<!-- End Page Vendor Js -->
<script src="<?php echo base_url(); ?>assets/app/js/components/notifications/notifications.min.js"></script>
