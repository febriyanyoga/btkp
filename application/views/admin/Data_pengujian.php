													...
													<tr>
														...
														<td class="text-center">
															...
															if ($ujian->foto_bukti_trf_1 == '' && $ujian->kode_billing_1 != '') {
																...
																?>
																<span style="width:100px; " title="Menunggu file survey diUnggah"><span class="badge-text badge-text-small info">Menunggu verifikasi dan Kode NTPN</span></span>
																<?php
															}
															?>
														</td>
                                                        			...
                                                        			<td class="text-center">
                                                        				...
                                                        				if($ujian->foto_bukti_trf_2 == ''){
                                                        					if($ujian->kode_billing_2 == ''){
                                                        						?>
                                                        						<span style="width:100px;"><span class="badge-text badge-text-small info">Menunggu Kode NTPN</span></span>
                                                        						<?php
                                                        					}else{
                                                        						?>
