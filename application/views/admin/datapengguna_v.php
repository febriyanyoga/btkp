													...
													<tr>
														...
														<td class="text-center">
															...
															if($pengguna->status_akun == 'aktif'){
																...
																?>
																<span style="width:100px;"><span class="badge-text badge-text-small danger" ><?php echo $pengguna->status_akun?></span></span>
																<?php
															}
															?>
														</td>
														<td class="text-center">
															<a href="#" data-toggle="modal" data-target="#edit-<?php echo $pengguna->id_pengguna?>" class="btn btn-success btn-sm" title="Ubah"><i class="la la-pencil"></i></i></a>
															...
															if($pengguna->status_akun == 'non-aktif' || $pengguna->status_email == 'non-aktif'){
																?>
																<a href="<?php echo site_url('aktif_admin/'.$pengguna->id_pengguna)?>" class="btn btn-info btn-sm" title="aktif"><i class="la la-check"></i></i></a>
																<?php
															}elseif ($pengguna->status_akun == 'aktif') {
																?>
																<a href="<?php echo site_url('non_aktif_admin/'.$pengguna->id_pengguna)?>" class="btn btn-danger btn-sm" title="non-aktif"><i class="la la-power-off"></i></i></a>
																<?php
															}
															?>
														</td>
													...
													<div id="edit-<?php echo $pengguna->id_pengguna?>" class="modal fade">
														<div class="modal-dialog modal-lg">
															<div class="modal-content">
																...
																<form action="<?php echo site_url('edit_pengguna')?>" method="POST" enctype="multipart/form-data">
																	<div class="modal-body">
																		<div class="form-group row mb-3">
																			<div class="col-xl-6 mb-3">
																				<label class="form-control-label">Nama pengguna<span class="text-danger ml-2">*</span></label>
																				<input type="text" value="<?php echo $pengguna->nama_pengguna?>" class="form-control" id="nama_pengguna" name="nama_pengguna" required>
																				<input type="hidden" value="<?php echo $pengguna->id_pengguna?>" class="form-control" id="id_pengguna" name="id_pengguna" required>
																			</div>
																			<div class="col-xl-6 mb-3">
																				<label class="form-control-label">Alamat email<span class="text-danger ml-2">*</span></label>
																				<input type="email" value="<?php echo $pengguna->email_pengguna?>" class="form-control" id="email_pengguna" name="email_pengguna" required>
																			</div>
																		</div>
																		<div class="form-group row mb-3">
																			<div class="col-xl-6 mb-3">
																			...
																			<div class="col-xl-6 mb-3">
																				<label class="form-control-label">Nomor Handphone<span class="text-danger ml-2">*</span></label>
																				<input type="number" value="<?php echo $pengguna->no_hp?>" class="form-control" id="no_hp" name="no_hp" required>
																			</div>
																		</div>
																		<div class="form-group row mb-3">
																			<div class="col-xl-6 mb-3">
																			...
																			<div class="col-xl-6 mb-3">
																				<label class="form-control-label">Konfirmasi password<span class="text-danger ml-2">*</span></label>
			...
			<form action="<?php echo site_url('daftar_admin')?>" method="POST">
				<div class="modal-body">
					<div class="form-group row mb-3">
						<div class="col-xl-6 mb-3">
							<label class="form-control-label">Nama pengguna<span class="text-danger ml-2">*</span></label>
							<input type="text" value="" class="form-control" id="nama_pengguna" name="nama_pengguna" required>
						</div>
						<div class="col-xl-6 mb-3">
							<label class="form-control-label">Alamat email<span class="text-danger ml-2">*</span></label>
							<input type="email" value="" class="form-control" id="email_pengguna" name="email_pengguna" required>
						</div>
					</div>
					<div class="form-group row mb-3">
						<div class="col-xl-6 mb-3">
