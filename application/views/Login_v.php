					...
					<div class="authentication-col-content-2 mx-auto text-center">
						...
						<ul class="login-nav nav nav-tabs mt-5 justify-content-center" role="tablist" id="animate-tab">
							<li><a class="active" data-toggle="tab" href="#singin" role="tab" id="singin-tab"
									data-easein="zoomInUp">Masuk</a></li>
							<li><a data-toggle="tab" href="#signup" role="tab" id="signup-tab"
									data-easein="zoomInRight">Daftar</a></li>
						</ul>
						<br>
					</div>
				</div>
								...
								<div class="widget-body">
									<form action="<?php echo site_url('daftar'); ?>" method="post" id="signupForm">
										<div class="form-group row">
											<div class="col-xl-6">
												<div class="group material-input">
													<input class="form-control" type="text" id="nama_pengguna"
														name="nama_pengguna" placeholder="Nama">
											...
											<div class="col-xl-6">
												<div class="group material-input">
													<input class="form-control" type="email" id="email_pengguna"
														name="email_pengguna" placeholder="Alamat Email">
													<span class="highlight"></span>
													<span class="bar"></span>
											...
											<div class="col-xl-6">
												<div class="group material-input">
													...
													<select class="form-control" id="id_jabatan" name="id_jabatan"
														required="required" title="pilih jenis user">
														<?php
											...
											<div class="col-xl-6">
												<div class="group material-input">
													<input class="form-control" type="password" id="confirm_password"
														name="confirm_password" placeholder="Konfrimasi Password">
													<span class="highlight"></span>
													<span class="bar"></span>
										...
										<div>
											<div class="group material-input">
												<input class="form-control" type="text" id="captcha2" name="captcha2"
													placeholder="Masukkan captcha">
												<span class="highlight"></span>
												<span class="bar"></span>
										...
										<div class="row">
											<div class="col text-left">
												<div class="styled-checkbox">
													...
													<label for="agree">Saya Menerima <a href="#" data-toggle="modal"
															data-target="#syarat">Syarat dan Ketentuan</a></label>
												</div>
