 ...
 <!--  <tr>
  ...
  <tr>
    <td align="justify" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-bottom: 3px; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 12pt; font-weight: 300; line-height: 150%;
      padding-top: 5px;
      color: #000000;
      font-family: sans-serif;" class="subheader">Permohonan dengan nomor <b><?php echo $nomor?></b> sudah mendapatkan respon dari Petugas Balai Teknologi Kelautan dan Perikanan (BTKP). Kami persilahkan anda untuk melihat progress permohonan tersebut pada aplikasi.
    </td>
  </tr>
      ...
      font-family: sans-serif;" class="footer"><!-- 
        ...
        Copyright © 2018 <a href="https://ugm.ac.id/" target="_blank" style="text-decoration: underline; color: #999999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;"> UGM </a>. All rights reserved.  -->
         <p style="text-align:center;"><img src="https://github.com/febriyanyoga/btkp/blob/master/assets/logo.png?raw=true" style="margin:0 auto 0 auto;display:inline-block;" width="90"></p>
                   ...
                   Balai Teknologi Kelautan dan Perlayaran<br>

                  Jl. Raya Ancol Baru No. 1 Kalijabat, Tanjung Priok<br>

                Jakarta Utara, Indonesia 14310<br>

                 Telp: (021) 4356767 Email: btkpjenhubla@yahoo.com<br>
