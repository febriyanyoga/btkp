 ...
 <!--  <tr>
  ...
  <tr>
    <td align="justify" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-bottom: 3px; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 12pt; font-weight: 300; line-height: 150%;
      padding-top: 5px;
      color: #000000;
      font-family: sans-serif;" class="subheader">Permohonan dengan nomor <b><?php echo $nomor?></b> sudah mendapatkan respon dari Petugas Balai Teknologi Keselamatan Pelayaran (BTKP). Kami persilahkan anda untuk melihat progress permohonan tersebut pada aplikasi.
    </td>
  </tr>
