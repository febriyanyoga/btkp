...
<table border="0" cellpadding="0" cellspacing="0" align="center"
	...
	<tr>
		<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 18pt; font-weight: 300; line-height: 150%;
			padding-top: 30px;
			color: #000000;
	...
	<tr>
		<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-bottom: 3px; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 12pt; font-weight: 300; line-height: 150%;
			...
			color: #000000;
			font-family: sans-serif;" class="subheader">
			Untuk mengatur ulang password anda, silahkan klik tombol <b>Atur ulang password</b> dibawah ini.
		</td>
	</tr>
	...
	<tr>
		<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
			...
			href="<?php echo base_url('atur_ulang/'.$token)?>" target="_blank">
				<table border="0" cellpadding="0" cellspacing="0" align="left" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;"><tr><td align="left" valign="middle" style="padding: 12px 24px; margin: 0; border-collapse: collapse; border-spacing: 0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;"
					...
					href="<?php echo base_url('atur_ulang/'.$token)?>">
						Atur ulang password
					</a>
			</td></tr></table></a>
		</td>
	...
	<tr>
		<td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
			...
			color: #000000;
			font-family: sans-serif;" class="paragraph">
				Atau copy <b>LINK</b> dibawah ini dan paste kan di <b>URL</b> browser anda.<a href="<?php echo base_url('atur_ulang/'.$token)?>"><br><p style="font-style: italic;"><?php echo base_url('atur_ulang/'.$token)?></p></a>
		</td>
	</tr>
		...
		<td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 13px; font-weight: 400; line-height: 150%;
			...
			font-family: sans-serif;" class="footer"><!-- 
				...
				Copyright © 2018 <a href="https://ugm.ac.id/" target="_blank" style="text-decoration: underline; color: #999999; font-family: sans-serif; font-size: 13px; font-weight: 400; line-height: 150%;"> UGM </a>. All rights reserved.  -->
				 <p style="text-align:center;"><img src="https://github.com/febriyanyoga/btkp/blob/master/assets/logo.png?raw=true" style="margin:0 auto 0 auto;display:inline-block;" width="90"></p>

                   Balai Teknologi Keselamatan Pelayaran<br>

                  Jl. Raya Ancol Baru No. 1, Tanjung Priok<br>

                Jakarta Utara, Indonesia 14310<br>

                 Telp: (021) 4356767 Email: btkp.perhubungan@gmail.com<br>
