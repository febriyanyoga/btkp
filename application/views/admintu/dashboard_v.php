				...
				<div class="widget-body">
					<div class="row">
						<div class="col-xl-12 d-flex flex-column justify-content-center align-items-center">
							...
							<a href="<?php echo site_url('tatausaha'); ?>">
								<a href="<?php echo site_url('perizinan')?>" class="btn btn-gradient-03 mr-1 mb-2">Detail</a>
							</a>
						</div>
					</div>
				</div>
				...
				<div class="widget-body">
					<div class="row">
						<div class="col-xl-12 d-flex flex-column justify-content-center align-items-center">
							...
							<a href="<?php echo site_url('tatausaha'); ?>">
								<a href="<?php echo site_url('pengujian')?>" class="btn btn-gradient-03 mr-1 mb-2">Detail</a>
							</a>
						</div>
					</div>
				</div>
				...
				<div class="widget-body">
					<div class="row">
						<div class="col-xl-12 d-flex flex-column justify-content-center align-items-center">
							...
							<a href="<?php echo site_url('tatausaha'); ?>">
								<a href="<?php echo site_url('reinspeksi')?>" class="btn btn-gradient-03 mr-1 mb-2">Detail</a>
							</a>
						</div>
					</div>
				</div>
