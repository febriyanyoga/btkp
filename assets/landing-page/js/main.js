	...
	function ln_backgrounds() {
		...
		if ($body.hasClass('slideshow-background')) {
			$body.vegas({
				...
				slides: [
					{ src: 'assets/landing-page/demo/images/image-15.jpg' },
					{ src: 'assets/landing-page/demo/images/image-16.jpg' },
					{ src: 'assets/landing-page/demo/images/image-17.jpg' },
					{ src: 'assets/landing-page/demo/images/image-4.jpg' }
				]
			});
		}
		...
		if ($body.hasClass('slideshow-video-background')) {
			$body.vegas({
				...
				slides: [
					{ src: 'assets/landing-page/demo/images/image-15.jpg' },
					{ src: 'assets/landing-page/demo/video/marine.jpg',
						video: {
							src: [
								'assets/landing-page/demo/video/marine.mp4',
								'assets/landing-page/demo/video/marine.webm',
								'assets/landing-page/demo/video/marine.ogv'
							],
							loop: false,
							mute: true
						}
		...
		if ($body.hasClass('kenburns-background')) {
			...
			var kenburnsBackgrounds = [
				{ src: 'assets/landing-page/demo/images/image-15.jpg', valign: 'top' },
				{ src: 'assets/landing-page/demo/images/image-14.jpg', valign: 'top' },
				{ src: 'assets/landing-page/demo/images/image-17.jpg', valign: 'top' }
			];
